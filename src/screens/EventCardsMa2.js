        ...
        return (
            <View style={styles.cardStyles}>
                ...
                <View style={{ alignSelf:'center', width:'95%',justifyContent:'center', paddingVertical:10}}>
                    <Text style={{fontSize:Responsive.font(13), color:'#585858', fontFamily:'Lato-Bold'}}>{this.state.useNewName?this.state.newName:data.tournamentName}</Text>
                </View>
                ...
                <View style={{  width:'95%', alignSelf:'center', justifyContent:'space-between', flexDirection:'row', paddingVertical:10}}>
                    ...
                    <View style={{flex:1, flexDirection:'row',justifyContent:'flex-end' }}>
                        <Icon type="Entypo" name="back-in-time"  style={{ alignSelf:'center',fontSize:Responsive.font(14) ,color: '#666666'}}/>
                        <Text  style={{fontSize:Responsive.font(11), color:'#008080', fontFamily:'Lato-Bold', alignSelf:'center', paddingLeft:5}}>Pending Approval</Text>
