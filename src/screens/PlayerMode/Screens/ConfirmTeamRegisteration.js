...
class ConfirmTeamRegisterationScreen extends Component {
  ...
  render() {
    return (
      <View style={{flex:1, backgroundColor:'white'}}>
        <Text style={{alignSelf:'center', paddingTop:10, color:'#585858', fontFamily:'Lato-Bold', fontSize:Responsive.font(13)}}> You have successfully registered your team!</Text>
        ...
        <View style={{flexDirection:'row', justifyContent:'space-around', paddingTop:20, paddingHorizontal:40}}>
            <TouchableOpacity onPress={()=>this.copyToClipboard()} style={{backgroundColor:'#A1E9F7', paddingHorizontal:20, paddingVertical:5, borderRadius:5}}>
                <Text style={{color:'#585858', fontFamily:'Lato-Medium', fontSize:Responsive.font(12)}}>Copy team Invite Link</Text>
            </TouchableOpacity>
...
export default ConfirmTeamRegisterationScreen;
