...
class InvitePlayersScreenTwo extends Component {
  ...
  render() {
    return (
      <View style={{flex:1, backgroundColor:'white'}}>
        <Text style={{alignSelf:'center', paddingTop:10, color:'#585858', fontFamily:'Lato-Bold', fontSize:Responsive.font(13)}}> You have registered in this event!</Text>
...
export default InvitePlayersScreenTwo;
